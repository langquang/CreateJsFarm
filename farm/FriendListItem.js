...
p.setFriendInfo = function (friend_data, anim_data, frame_1, frame_2) {
    ...
    // txtName
    this._txtName = new createjs.Text( this._data.name, "bold 12px Arial", "#000");
    this._txtName.textAlign = "center";
    this._txtName.x = 0;
    this._txtName.y = -45;
    this.addChild(this._txtName);
    // txtName
    this._txtLevel = new createjs.Text( this._data.level, "bold 14px Arial", "#000");
    this._txtLevel.x = 8;
    this._txtLevel.y = 25;
